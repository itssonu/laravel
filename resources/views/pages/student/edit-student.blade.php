    ...
    <div class="content">
        ...
        ">
            ...
            <div class="block-header">
                <h3 class="block-title">Upadate Student Data</h3>
            </div>
            <div class="block-content block-content-full">
                <form action="{{ url('admin/update-student') }}/{{$data->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        {{-- <div class="col-lg-4">
                        ...
                        <div class="col-lg-12 col-xl-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-alt" id="example-text-input-alt"
                                    name="name" placeholder="Text Input" value="{{$data->name}}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-alt" id="example-password-input-alt"
                                    name="class" placeholder="Password Input" value="{{$data->class}}">
                            </div>
                            {{-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-alt"
                                    id="example-password-input-alt" name="roll" placeholder="Password Input" value="{{$data->roll}}">
                            </div>
                            <div class="form-group">
                                <label>Image</label>
                                <div class="custom-file">
                                    <input name="image" type="file">
                                    <input name="hidden_image" type="hidden" value="{{$data->image}}">
                                    {{-- <label class="custom-file-label" for="example-file-input-custom">Choose file</label> --}}
                                </div>
                                <div><img height="200" width="200" src="{{ asset('student/images') }}/{{$data->image}}" > </div>
                            </div>
